...
int main () {
   ...
   char threadid[10][15] = {"Amritha","Praveen","Saurabh","Sangeetha","Lakshmy","Srinivasan","Ramaguru"};
   ...
   for(int i = 0; i < 7; i++ ) {
      ...
      result = pthread_create(&threads[i], NULL, printWelcomeMessage, (void *)threadid[i]);
